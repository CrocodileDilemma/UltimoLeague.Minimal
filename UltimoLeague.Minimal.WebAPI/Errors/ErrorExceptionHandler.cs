...
namespace UltimoLeague.Minimal.WebAPI.Errors
{
    ...
    public static class ExceptionHandlerExtensions
    {
        ...
        public static void UseErrorExceptionHandler(this IApplicationBuilder app, ILogger? logger = null, bool logStructuredException = false)
        {
...
{exHandlerFeature.Error.StackTrace}";
                        ...
                        await ctx.Response.WriteAsJsonAsync(new
                        {
                            ...
                            Message = "One or more unexpected errors occured!",
                            Errors = new
                            {
