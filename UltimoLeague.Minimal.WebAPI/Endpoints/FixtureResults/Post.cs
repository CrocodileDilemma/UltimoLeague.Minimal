...
{
    [HttpPost("results")]
    public class Post : Endpoint<FixtureResultRequest, Result<IEnumerable<FixtureResultDto>>>
    {
        ...
        public override async Task HandleAsync(FixtureResultRequest request, CancellationToken ct)
        {
            ...
            await SendCreatedAtAsync<GetByFixtureId>( new { Id = result.Value.First().FixtureId }, result,
